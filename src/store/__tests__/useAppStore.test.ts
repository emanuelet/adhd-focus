...
const mockState: AppState = {
  ...
  captures: [
    { id: 'c1', text: 'test', isUrl: false, createdAt: '2024-01-01', sentToTodoist: false },
  ],
}
...
describe('useAppStore', () => {
  ...
  describe('setEnergy', () => {
    ...
    it('preserves existing energy entries', () => {
      ...
      expect(useAppStore.getState().energyMap).toEqual({ t1: 'high', t2: 'low' })
    })
  })
  ...
  describe('addCapture', () => {
    it('prepends capture to list', () => {
      ...
      useAppStore.getState().addCapture({
        id: 'c2', text: 'new', isUrl: true, createdAt: '2024-01-02', sentToTodoist: false,
      })
  ...
  describe('updateCapture', () => {
    it('patches a capture field', () => {
      useAppStore.getState().hydrate(mockState)
      useAppStore.getState().updateCapture('c1', { sentToTodoist: true, todoistTaskId: 'r1' })
