...
export function FocusBanner({
	...
	return (
		<div className="rounded-xl border border-[var(--accent)] bg-[var(--accent-dim)] p-4 mb-4">
			...
			<p className="text-sm font-medium text-[var(--text)] truncate mb-3">
				{task.content}
			</p>

			<div className="flex items-center gap-3">
				<span className="text-lg font-mono font-medium text-[var(--accent)]">
					{formatted}
				</span>
				<div className="flex-1 h-1.5 rounded-full bg-[var(--bg)] overflow-hidden">
					<div
						...
						style={{
							...
							backgroundColor:
								phase === "work" ? "var(--accent)" : "var(--green)",
						}}
					/>
				</div>
			</div>
